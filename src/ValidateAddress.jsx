...
const ValidateAddress = () => {
  ...
  const fetchAddress = async () => {
    const response = await fetch(`http://localhost:3000/customeraddress`);
  ...
  const handleSubmit = async (e) => {
    ...
    const requestRes = await fetch(`http://localhost:3000/validateaddress?address=${address}&state=${state}&zip=${zip}`);
