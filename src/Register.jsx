...
const Register = () => {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      let res = await fetch("http://localhost:5000/api/accounts", {
        method: "POST",
        body: JSON.stringify({
      ...
      if (res.ok && resJson.success) {
        ...
        setMessage(
          `Congratulations, Your Account Has Been Successfully Created. Account id is ${resJson.accountnumber}`
        );
      } else {
  ...
  return (
    <section className="vh-100 gradient-custom">
      <div className="container py-5 h-100">
        <div className="row justify-content-center align-items-center h-100" data-testid="customer-account-register">
          <div className="col-12 col-lg-9 col-xl-7">
            <div className="card shadow-2-strong card-registration">
              <div className="card-body p-4 p-md-5">
                <h3 className="mb-4 pb-2 pb-md-0 mb-md-5"><span data-testid="register">Registration</span> </h3>
